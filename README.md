...
This workspace contains multiple independent frontend assignments (each folder is a standalone Vite + React project). Use the summaries below to pick which demo to run.
...
Note: Each project is intended to run independently; you can open and run any of the three projects separately.
...
- Plain CSS / component CSS files

---

## 🚀 Quick Start — Run any project locally

Prerequisites: Node.js 18+ and npm.

1. Open a terminal and change into the project folder you want to run. Examples:
...
4. Open the address shown by Vite (typically `http://localhost:5173`) in your browser.
...
6. To run linters (if the project includes lint scripts):
